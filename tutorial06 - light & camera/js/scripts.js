document.addEventListener("DOMContentLoaded", function(event) { 
  ...
  var lightSpot = new THREE.SpotLight(0xffffff, 4.0, 3000);
  lightSpot.position.y = 100;
  lightSpot.position.y = 150;
  lightSpot.target = mesh;
  
  lightSpot.castShadow = true;
  lightSpot.shadow = new THREE.LightShadow( new THREE.PerspectiveCamera( 100, 1, 500, 1000 ) );
  lightSpot.shadow.bias = 0.0001;    
  lightSpot.shadow.mapSize.width = 2048 * 2;
  lightSpot.shadow.mapSize.height = 2048 * 2;
  scene.add(lightSpot);
